        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
              ...
              <BadgeCheck className="h-5 w-5 text-emerald-400 self-start sm:self-auto flex-shrink-0" />
            </div>
            ...
            <Link 
              ...
              className="mt-4 flex w-full items-center justify-center rounded-md bg-emerald-500 h-9 px-4 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-emerald-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
            >
