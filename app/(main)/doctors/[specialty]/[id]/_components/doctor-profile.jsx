...
import { User, Medal, ChevronUp, ChevronDown, FileText, Clock, Calendar, Info } from "lucide-react";
          ...
          <Card className="border-teal-900/20">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-teal-900/20">
                  {doctor.imageUrl ? (
                    <Image
                      src={doctor.imageUrl}
                ...
                {doctor.specialty && (
                  <Badge
                    variant="outline"
                    className="bg-teal-900/20 border-teal-900/30 text-teal-400 mb-4"
                  >
                    {doctor.specialty}
                  </Badge>
                )}
      ...
      <div className="md:col-span-2 space-y-6">
        <Card>
          ...
          <CardContent>
            ...
            <Separator className="my-6 bg-teal-900/20" />
            ...
            <div className="space-y-4">
              ...
              {totalSlots > 0 ? (
                ...
                <div className="rounded-lg border border-teal-900/20 bg-teal-900/10 p-4 flex gap-3 text-muted-foreground items-start">
