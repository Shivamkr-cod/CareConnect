    ...
    <div className="space-y-6">
      ...
      <Card className="border-teal-900/20">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-teal-900/20">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                ...
                <Badge
                  variant="outline"
                  className="bg-teal-900/20 border-teal-900/30 text-teal-400"
                >
                  Available
                </Badge>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-teal-900/10"
                  >
                    <div>
                      <p className="text-white font-medium">
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-teal-900/20 pt-2 flex justify-between font-medium">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background border-teal-900/20"
                required
              />
              <p className="text-sm text-muted-foreground">
